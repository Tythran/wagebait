...
export default function BetModal({ maxBet, bet }: { maxBet: number; bet: (n: number) => void }) {
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content text-bg-dark">
          ...
          <div className="modal-footer">
            ...
            <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={() => bet(betAmount)}>
              Place bet
            </button>
          </div>
        </div>
